...
public:
	...
	std::vector<std::pair<int, int>> getLavaPositions();
	std::vector<std::pair<int, int>> getSuccessBox();
...
private:
	...
	std::vector<std::pair<int, int>> m_lava;
	std::vector<std::pair<int, int>> m_successBox;
	int m_tileCount;
	int m_tilesetWidth;
	int m_tileWidth;
	int m_tileHeight;
